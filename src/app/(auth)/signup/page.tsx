  ...
  return (
    <div className="screen bg-gray-50 dark:bg-neutral-950 animate-page-in">
      ...
      <div className="flex items-center justify-between px-5 flex-shrink-0"
        ...
        <Link href="/login" className="text-sm text-indigo-600 dark:text-indigo-400 font-semibold">
          Sign in →
        </Link>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 flex flex-col justify-center"
        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">
            {mode === "email" ? "Create your account" : "Get started free"}
          </h1>
          ...
          {mode === "options" ? (
            ...
            <form onSubmit={handleSignup} className="space-y-4 animate-page-in">
              ...
              <p className="text-xs text-center text-gray-400 dark:text-neutral-600 pt-1">
...
function OAuthButton({ provider, loading, onClick }: { provider: "google" | "apple"; loading: boolean; onClick: () => void }) {
  if (provider === "google") {
    return (
      <button onClick={onClick} disabled={loading}
        ...
        {loading ? <span className="w-5 h-5 border-2 border-gray-300 border-t-indigo-600 rounded-full animate-spin" /> : (
  ...
  return (
    <button onClick={onClick} disabled={loading}
      ...
      {loading ? <span className="w-5 h-5 border-2 border-gray-600 border-t-white rounded-full animate-spin" /> : (
